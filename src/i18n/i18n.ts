...
i18n
  ...
  .init({
    ...
    fallbackLng: {
      // If 'en-US' then fallback to 'en' in i18n.ts, and so on
    ...
    resources: {
      en: {
        myKeys: {
          welcome: "Hi", // key 'welcome' in 'myKeys' namespace for English
          all_you_ever_wanted: "All you ever wanted to know about Movies!",
          language: "Language", // key 'language' in 'myKeys' namespace for English
          home: "Home",
          ...
          poor: "Poor",
          terrible: "Terrible",
          back_to_actor_page: "Back to the page of ",
          jump_to_actor_movies_page: "Check the actor's movies",
          back: "Back",
      ...
      es: {
        myKeys: {
          ...
          poor: "Pobre",
          terrible: "Terrible",
          back_to_actor_page: "Volver a la página de ",
          jump_to_actor_movies_page: "Ver las películas del actor ",
          back: "Atrás",
      ...
      pt: {
        myKeys: {
          ...
          language: "Idioma",
          all_you_ever_wanted:
            "Tudo o que você sempre quis saber sobre filmes!",
          home: "Início",
          ...
          first_name_text:
            "Por favor, insira seu nome (apenas letras e espaços)",
          last_name_text:
          ...
          poor: "Ruim",
          terrible: "Terrível",
          back_to_actor_page: "Voltar para a página de ",
          jump_to_actor_movies_page: "Ver os filmes do ator",
          back: "Voltar",
      ...
      it: {
        myKeys: {
          ...
          poor: "Scarso",
          terrible: "Terribile",
          back_to_actor_page: "Torna alla pagina di ",
          jump_to_actor_movies_page: "Guarda i film dell'attore",
          back: "Indietro",

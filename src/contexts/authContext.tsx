...
//   // const authenticate = useCallback(async (supabaseData: any) => {
//    const authenticate = useCallback(async (supabaseData: { user: UserType; session: SessionType }) => {
...
//       navigate(origin);
//     }
//     [t, location, navigate]; // dependencies used inside authenticate
//   });
